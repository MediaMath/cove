...
func TestSinglePathResult(t *testing.T) {
	cmd, err := gocmd.Prepare("list", "os/exec").StdOutLines()
...
func TestMultiPathResult(t *testing.T) {
	cmd, err := gocmd.Prepare("list", "os/...").StdOutLines()
...
func TestFailPathResult(t *testing.T) {
	cmd, err := gocmd.Prepare("list", "os/foodog").StdOutLines()
...
func TestFailPathResultWithPassingToo(t *testing.T) {
	cmd, err := gocmd.Prepare("list", "os/foodog", "os/signal").StdOutLines()
...
func TestFailPathResultWithErrorsOff(t *testing.T) {
	cmd, err := gocmd.Prepare("list", "-e", "os/foodog").StdOutLines()
...
func TestFailPathResultWithPassingTooWithErrorsOff(t *testing.T) {
	cmd, err := gocmd.Prepare("list", "-e", "os/foodog", "os/signal").StdOutLines()
